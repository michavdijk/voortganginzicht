...
const translations = {
  nl: {
    ...
    'help.workStructure.rollup':        'De voortgang van bovenliggende onderdelen wordt automatisch berekend op basis van de omvang en voortgang van onderliggende activiteiten.',
    ...
    'help.chart.actualSpending':        'Als de optie "Actuele besteding tonen" is ingeschakeld bij Instellingen, wordt bij activiteiten ook de actuele besteding weergegeven. Deze wordt getoond als een markering in de voortgangsbalk. De positie van deze markering laat zien hoeveel omvang er tot nu toe besteed is ten opzichte van de totale omvang van de activiteit. Op deze manier is in een oogopslag te zien of de activiteit voor of achter loopt op de planning.',
    ...
    'help.settings.sizeIndicators.heading': 'Omvangindicatoren',
    ...
    'help.settings.actualSpending.report': 'De actuele besteding wordt vervolgens ook weergegeven in het voortgangsrapport als markering in de voortgangsbalk van een activiteit.',
  ...
  en: {
    ...
    'help.workStructure.rollup':        'Progress for parent items is calculated automatically from the size and progress of the activities below them.',
    ...
    'help.chart.actualSpending':        'When "Show actual spending" is enabled in Settings, actual spending is also shown for activities. It appears as a marker in the progress bar. The marker position shows how much size has been spent so far compared with the activity’s total size. This makes it easy to see at a glance whether an activity is ahead of or behind plan.',
    ...
    'help.settings.sizeIndicators.heading': 'Size indicators',
    ...
    'help.settings.actualSpending.report': 'Actual spending is then also shown in the progress report as a marker in an activity’s progress bar.',
