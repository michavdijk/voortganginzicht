...
const translations = {
  nl: {
    ...
    'chart.placeholder.empty':          'Maak links een doel aan om het voortgangsrapport op te bouwen.',
    ...
    'help.workStructure.item4':         'Gebruik het plusje om een onderliggende knoop toe te voegen, de horizontale pijlen om het niveau te wijzigen en de verticale pijlen om onderdelen te ordenen.',
    ...
    'help.workStructure.item6':         'Voortgang is het percentage dat klaar is; leeg telt als 0%.',
    ...
    'tree.incomplete.omvangRequired':   'Omvang nodig voor rapport',
  ...
  en: {
    ...
    'chart.placeholder.empty':          'Create a goal on the left to build the progress report.',
    ...
    'help.workStructure.item4':         'Use the plus button to add a child node, the horizontal arrows to change the level, and the vertical arrows to order items.',
    ...
    'help.workStructure.item6':         'Progress is the percentage that is complete; empty counts as 0%.',
    ...
    'tree.incomplete.omvangRequired':   'Size needed for report',
