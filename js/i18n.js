...
const translations = {
  nl: {
    ...
    'panel.chart.ariaLabel':            'Voortgangsplaat',
    'panel.chart.header':               'Voortgangsplaat',
    'chart.placeholder':                'Vul de werkstructuur in — de voortgangsplaat verschijnt automatisch.',
    ...
    'help.workStructure.intro':         'De werkstructuur bestaat uit doelen, subdoelen en activiteiten. Het type van een knoop wordt automatisch bepaald door de plek in de structuur.',
    ...
    'help.chart.nav':                   'Voortgangsplaat',
    'help.chart.title':                 'Voortgangsplaat',
    'help.chart.intro':                 'De voortgangsplaat toont de werkstructuur als visuele voortgangsrapportage.',
    ...
    'help.chart.item4':                 'Pas de weergave van de plaat aan via Instellingen; open deze met het tandwiel bij de voortgangsplaat.',
    'help.chart.item5':                 'Gebruik Download als PNG om de huidige plaat als afbeelding op te slaan.',
    ...
    'help.files.intro':                 'Projectbestanden worden lokaal als JSON opgeslagen. De voortgangsplaat kun je als PNG downloaden.',
    ...
    'help.files.item3':                 'Download als PNG is beschikbaar zodra er een geldige voortgangsplaat is.',
    ...
    'error.noChart':                    'Er is nog geen voortgangsplaat om te downloaden.',
    ...
    'success.downloaded':               'Voortgangsplaat gedownload.',
  ...
  en: {
    ...
    'help.workStructure.intro':         'The work structure consists of goals, subgoals, and activities. A node’s type is determined automatically by its place in the structure.',
