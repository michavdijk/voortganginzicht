...
const translations = {
  nl: {
    ...
    'help.chart.item4':                 'Gebruik Download als PNG om de huidige plaat als afbeelding op te slaan.',
  ...
  en: {
    ...
    'help.chart.item4':                 'Use Download as PNG to save the current report as an image.',
